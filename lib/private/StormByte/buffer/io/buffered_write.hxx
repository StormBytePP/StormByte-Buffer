...
namespace StormByte {
	...
	namespace Buffer {
		...
		namespace IO {
			 ...
			 */
			class STORMBYTE_BUFFER_PRIVATE BufferedWrite {
				public:
					/**
					 * @name Lifecycle
					 * @{
					 ...
					 */
					BufferedWrite(Buffer::BufferedWrite& owner, std::size_t write_chunk,
					 ...
					 */
					BufferedWrite(BufferedWrite&&) = delete;
					 ...
					 * @return *this.
					 */
					BufferedWrite& operator=(BufferedWrite&&) = delete;
					 ...
					 */
					void Rebind(Buffer::BufferedWrite& owner) noexcept;
				...
				private:
					...
					Buffer::BufferedWrite* m_owner;				///< Public leaf (hooks).
