...
namespace StormByte {
	...
	namespace Buffer {
		 ...
		 * @brief @ref BufferedWrite leaf over a filesystem file.
		 *
		 ...
		 *
		 * @see BufferedWrite, IO::State
		 */
		class STORMBYTE_BUFFER_PUBLIC BufferedFileWriter: public BufferedWrite {
			public:
				/**
				 * @name Lifecycle
				 * @{
			...
			protected:
				 ...
				 */
				IO::Result OriginOpen() override;

				/**
				 * @brief Close the file stream.
				 * @return @ref IO::Status::Ok.
				 */
				IO::Result OriginClose() override;
				 ...
				 */
				IO::Result OriginPush(std::span<const std::byte> data) override;

				/**
				 * @brief Flush the output stream.
				 * @return @ref IO::Status::Ok, Error or Failed.
				 */
				IO::Result OriginFlush() override;

				/**
				 * @brief Resize the file to zero bytes.
				 * @return @ref IO::Status::Ok or @ref IO::Status::Failed.
				 */
				IO::Result OriginTruncate() override;
